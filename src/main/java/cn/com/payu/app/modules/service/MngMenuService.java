...
import cn.com.payu.app.common.enums.MenuType;
import cn.com.payu.app.common.exception.AppServerException;
import cn.com.payu.app.modules.converter.MenuConverter;
import cn.com.payu.app.modules.entity.Menu;
import cn.com.payu.app.modules.entity.RoleMenu;
import cn.com.payu.app.modules.mapper.MenuMapper;
...
import cn.com.payu.app.modules.model.MenuTreeModel;
import cn.com.payu.app.modules.model.params.MenuBO;
import cn.com.payu.app.modules.model.params.MenuSearch;
import cn.com.payu.app.modules.model.params.MenuTreeSearch;
...
import static cn.com.payu.app.common.constant.RedisConstants.FIVE_SECONDS;
import static cn.com.payu.app.common.constant.RedisConstants.MENU_NO_LOCK;

@Slf4j
@Service
public class MngMenuService {
    ...
    public PageInfo<MenuDTO> search(MenuSearch search) {
        ...
        search.setRoleIds(MngContextHolder.getRoleIds());
     ...
     * @return
     */
    public List<MenuModel> getMenuFullTreeWithChecked(Collection<Long> roleIds, Long editRoleId) {
     ...
     * @return
     */
    public List<MenuModel> getMenuTree(Collection<Long> roleIds) {
     ...
     * @return
     */
    public List<MenuModel> getMenuTreeByParentId(Long parentId, Collection<Long> roleIds) {
    ...
    public Long generateMenuNo(Long parentMenuNo) {
        ...
        if (!setnx) {
            throw new AppServerException(600, "系统繁忙，请稍后重试");
        }
        String menuNo;
        try {
    ...
    public void add(MenuBO menuBO) {
        ...
        if (menuDept >= MAX_DEPTH) {
            throw new AppServerException(String.format("目前系统菜单最大层级限制%d级", MAX_DEPTH));
        }
        ...
        roleMenu.setRoleId(MngContextHolder.ADMIN_ROLE_ID);
    ...
    public void checkAddMenu(MenuBO menuBO) {
        ...
        if (cnt > 0) {
            throw new AppServerException("同级菜单名称已存在");
        }
    }
    ...
    public void logicDeleteById(Long id) {
        Menu menu = menuMapper.selectById(id);
        log.warn("{}删除菜单{}", MngContextHolder.getAccount(), menu.toString());
