package cn.com.payu.app.modules.utils.idcardUtil;
...
public class IdcardInfoExtractor {
    ...
    public String toString() {
        return "IdcardInfoExtractor [gender=" + gender + ", age=" + age + "]";
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(DateUtils.format(ie.getBirthday()));
        System.out.println(ie.getGender());
        System.out.println(ie.getZhGender());
    }
